###########################################################################
## Makefile generated for component 'Lab4_Model'. 
## 
## Makefile     : Lab4_Model.mk
## Generated on : Tue Sep 20 12:15:16 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Lab4_Model.rt-win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Lab4_Model.rt-win64
...
DEFINES_STANDARD = -DMODEL=Lab4_Model -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Lab4_Model_quarc_win64\Lab4_Model.c $(START_DIR)\Lab4_Model_quarc_win64\Lab4_Model_data.c $(START_DIR)\Lab4_Model_quarc_win64\Lab4_Model_main.c $(START_DIR)\Lab4_Model_quarc_win64\rtGetInf.c $(START_DIR)\Lab4_Model_quarc_win64\rtGetNaN.c $(START_DIR)\Lab4_Model_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Lab4_Model.obj Lab4_Model_data.obj Lab4_Model_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Lab4_Model_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Lab4_Model_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Lab4_Model.obj : "$(START_DIR)\Lab4_Model_quarc_win64\Lab4_Model.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab4_Model_quarc_win64\Lab4_Model.c"


Lab4_Model_data.obj : "$(START_DIR)\Lab4_Model_quarc_win64\Lab4_Model_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab4_Model_quarc_win64\Lab4_Model_data.c"


Lab4_Model_main.obj : "$(START_DIR)\Lab4_Model_quarc_win64\Lab4_Model_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab4_Model_quarc_win64\Lab4_Model_main.c"


rtGetInf.obj : "$(START_DIR)\Lab4_Model_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab4_Model_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Lab4_Model_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab4_Model_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Lab4_Model_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab4_Model_quarc_win64\rt_nonfinite.c"
