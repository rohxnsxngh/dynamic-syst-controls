...
#ifndef RTW_HEADER_Lab5_Model_h_
#define RTW_HEADER_Lab5_Model_h_
#ifndef Lab5_Model_COMMON_INCLUDES_
#define Lab5_Model_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* Lab5_Model_COMMON_INCLUDES_ */

#include "Lab5_Model_types.h"
#include "rtGetInf.h"
...
#define Lab5_Model_rtModel             RT_MODEL_Lab5_Model_T

/* Block signals (default storage) */
typedef struct {
  real_T Tank2OutputFilter;            /* '<S2>/Tank 2 Output Filter' */
  real_T Step;                         /* '<Root>/Step' */
  real_T HILReadAnalog_o1;             /* '<Root>/HIL Read Analog' */
  real_T HILReadAnalog_o2;             /* '<Root>/HIL Read Analog' */
  real_T Multiply;                     /* '<S2>/Multiply' */
  real_T Gain1;                        /* '<Root>/Gain1' */
  real_T Derivative;                   /* '<Root>/Derivative' */
  real_T Gain3;                        /* '<Root>/Gain3' */
  real_T y;                            /* '<Root>/Tank 2 Calibration' */
  boolean_T Memory;                    /* '<S3>/Memory' */
  boolean_T Logic[2];                  /* '<S3>/Logic' */
  boolean_T Logic_i[2];                /* '<S4>/Logic' */
} B_Lab5_Model_T;
...
typedef struct {
  real_T Tank2OutputFilter_CSTATE;     /* '<S2>/Tank 2 Output Filter' */
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
  real_T Tank1RawFilter_CSTATE;        /* '<S2>/Tank 1 Raw Filter' */
  real_T Tank2RawFilter_CSTATE;        /* '<S2>/Tank 2 Raw Filter' */
} X_Lab5_Model_T;
...
/* State disabled  */
typedef struct {
  boolean_T Tank2OutputFilter_CSTATE;  /* '<S2>/Tank 2 Output Filter' */
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
  boolean_T Integrator_CSTATE;         /* '<Root>/Integrator' */
  boolean_T Tank1RawFilter_CSTATE;     /* '<S2>/Tank 1 Raw Filter' */
  boolean_T Tank2RawFilter_CSTATE;     /* '<S2>/Tank 2 Raw Filter' */
} XDis_Lab5_Model_T;
...
#define rtB                            Lab5_Model_B
#define BlockIO                        B_Lab5_Model_T
#define rtX                            Lab5_Model_X
#define ContinuousStates               X_Lab5_Model_T
#define rtXdot                         Lab5_Model_XDot
#define StateDerivatives               XDot_Lab5_Model_T
#define tXdis                          Lab5_Model_XDis
#define StateDisabled                  XDis_Lab5_Model_T
#define rtP                            Lab5_Model_P
#define Parameters                     P_Lab5_Model_T
#define rtDWork                        Lab5_Model_DW
#define D_Work                         DW_Lab5_Model_T

/* Parameters (default storage) */
struct P_Lab5_Model_T_ {
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T Tank2OutputFilter_A;         /* Computed Parameter: Tank2OutputFilter_A
                                       * Referenced by: '<S2>/Tank 2 Output Filter'
                                       */
  real_T Tank2OutputFilter_C;         /* Computed Parameter: Tank2OutputFilter_C
                                       * Referenced by: '<S2>/Tank 2 Output Filter'
                                       */
  ...
  real_T TransferFcn_C;                /* Computed Parameter: TransferFcn_C
                                        * Referenced by: '<Root>/Transfer Fcn'
                                        */
  real_T Step_Time;                    /* Expression: 150
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_Y0;                      /* Expression: 10
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: 12
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Integrator_IC;                /* Expression: 0
                                        * Referenced by: '<Root>/Integrator'
                                        */
  real_T Saturation_UpperSat;          /* Expression: 22
  ...
  real_T Gain_Gain;                    /* Expression: 1/3
                                        ...
                                        */
  real_T Tank1RawFilter_A;             /* Computed Parameter: Tank1RawFilter_A
                                        * Referenced by: '<S2>/Tank 1 Raw Filter'
                                        */
  real_T Tank1RawFilter_C;             /* Computed Parameter: Tank1RawFilter_C
                                        * Referenced by: '<S2>/Tank 1 Raw Filter'
                                        */
  real_T Tank1StopLimit_Value;         /* Expression: 4.2
                                        * Referenced by: '<S2>/Tank 1 Stop Limit'
                                        */
  real_T Tank2RawFilter_A;             /* Computed Parameter: Tank2RawFilter_A
                                        * Referenced by: '<S2>/Tank 2 Raw Filter'
                                        */
  real_T Tank2RawFilter_C;             /* Computed Parameter: Tank2RawFilter_C
                                        * Referenced by: '<S2>/Tank 2 Raw Filter'
                                        */
  real_T Tank2StopLimit_Value;         /* Expression: 4.2
                                        * Referenced by: '<S2>/Tank 2 Stop Limit'
                                        */
  real_T Tank1RestartLevel_Value;      /* Expression: 3.8
                                        * Referenced by: '<S2>/Tank 1 Restart Level'
                                        */
  real_T Tank2RestartLevel_Value;      /* Expression: 3.8
                                        * Referenced by: '<S2>/Tank 2 Restart Level'
                                        */
  real_T CombinedVoltageLimit_Value;   /* Expression: 4.2
...
extern P_Lab5_Model_T Lab5_Model_P;

/* Block signals (default storage) */
extern B_Lab5_Model_T Lab5_Model_B;

/* Continuous states (default storage) */
extern X_Lab5_Model_T Lab5_Model_X;

/* Block states (default storage) */
extern DW_Lab5_Model_T Lab5_Model_DW;

/* Model entry point functions */
extern void Lab5_Model_initialize(void);
extern void Lab5_Model_output(void);
extern void Lab5_Model_update(void);
extern void Lab5_Model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Lab5_Model_rtModel *Lab5_Model(void);
...
extern RT_MODEL_Lab5_Model_T *const Lab5_Model_M;
 ...
 *
 * '<Root>' : 'Lab5_Model'
 * '<S1>'   : 'Lab5_Model/Tank 2 Calibration'
 * '<S2>'   : 'Lab5_Model/Tank Overflow Prevention'
 * '<S3>'   : 'Lab5_Model/Tank Overflow Prevention/S-R Flip-Flop'
 * '<S4>'   : 'Lab5_Model/Tank Overflow Prevention/S-R Flip-Flop1'
 */
#endif                                 /* RTW_HEADER_Lab5_Model_h_ */
