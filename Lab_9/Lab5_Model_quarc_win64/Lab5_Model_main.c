...
typedef RT_MODEL_Lab5_Model_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Lab5_Model(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Lab5_Model_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://Lab5_Model:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Lab5_Model -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
