...
#ifndef RTW_HEADER_OpenLoopControllerSim_1_h_
#define RTW_HEADER_OpenLoopControllerSim_1_h_
#ifndef OpenLoopControllerSim_1_COMMON_INCLUDES_
#define OpenLoopControllerSim_1_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                            /* OpenLoopControllerSim_1_COMMON_INCLUDES_ */

#include "OpenLoopControllerSim_1_types.h"
#include <string.h>
...
#define OpenLoopControllerSim_1_rtModel RT_MODEL_OpenLoopControllerSi_T

/* Block signals (default storage) */
typedef struct {
  real_T TransferFcn;                  /* '<Root>/Transfer Fcn' */
  real_T Gain;                         /* '<Root>/Gain' */
} B_OpenLoopControllerSim_1_T;
...
} DW_OpenLoopControllerSim_1_T;

/* Continuous states (default storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} X_OpenLoopControllerSim_1_T;

/* State derivatives (default storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} XDot_OpenLoopControllerSim_1_T;

/* State disabled  */
typedef struct {
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
} XDis_OpenLoopControllerSim_1_T;
...
#define rtB                            OpenLoopControllerSim_1_B
#define BlockIO                        B_OpenLoopControllerSim_1_T
#define rtX                            OpenLoopControllerSim_1_X
#define ContinuousStates               X_OpenLoopControllerSim_1_T
#define rtXdot                         OpenLoopControllerSim_1_XDot
#define StateDerivatives               XDot_OpenLoopControllerSim_1_T
#define tXdis                          OpenLoopControllerSim_1_XDis
#define StateDisabled                  XDis_OpenLoopControllerSim_1_T
#define rtP                            OpenLoopControllerSim_1_P
#define Parameters                     P_OpenLoopControllerSim_1_T
#define rtDWork                        OpenLoopControllerSim_1_DW
#define D_Work                         DW_OpenLoopControllerSim_1_T

/* Parameters (default storage) */
struct P_OpenLoopControllerSim_1_T_ {
  ...
  real_T Constant_Value;               /* Expression: 20
                                        ...
                                        */
  real_T Gain_Gain;                    /* Expression: 14.7839^-1
...
struct tag_RTM_OpenLoopControllerSim_T {
  const char_T *path;
...
extern P_OpenLoopControllerSim_1_T OpenLoopControllerSim_1_P;

/* Block signals (default storage) */
extern B_OpenLoopControllerSim_1_T OpenLoopControllerSim_1_B;

/* Continuous states (default storage) */
extern X_OpenLoopControllerSim_1_T OpenLoopControllerSim_1_X;

/* Block states (default storage) */
extern DW_OpenLoopControllerSim_1_T OpenLoopControllerSim_1_DW;

/* Model entry point functions */
extern void OpenLoopControllerSim_1_initialize(void);
extern void OpenLoopControllerSim_1_output(void);
extern void OpenLoopControllerSim_1_update(void);
extern void OpenLoopControllerSim_1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern OpenLoopControllerSim_1_rtModel *OpenLoopControllerSim_1(void);
...
extern RT_MODEL_OpenLoopControllerSi_T *const OpenLoopControllerSim_1_M;
 ...
 *
 * '<Root>' : 'OpenLoopControllerSim_1'
 */
#endif                               /* RTW_HEADER_OpenLoopControllerSim_1_h_ */
