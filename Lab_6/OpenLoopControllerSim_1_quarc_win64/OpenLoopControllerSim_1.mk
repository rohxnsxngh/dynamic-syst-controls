###########################################################################
## Makefile generated for component 'OpenLoopControllerSim_1'. 
## 
## Makefile     : OpenLoopControllerSim_1.mk
## Generated on : Tue Oct 18 11:25:55 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\OpenLoopControllerSim_1.rt-win64
...
PRODUCT_NAME              = OpenLoopControllerSim_1
MAKEFILE                  = OpenLoopControllerSim_1.mk
...
COMPILER_COMMAND_FILE     = OpenLoopControllerSim_1_comp.rsp
CMD_FILE                  = OpenLoopControllerSim_1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\OpenLoopControllerSim_1.rt-win64
...
DEFINES_STANDARD = -DMODEL=OpenLoopControllerSim_1 -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\OpenLoopControllerSim_1_quarc_win64\OpenLoopControllerSim_1.c $(START_DIR)\OpenLoopControllerSim_1_quarc_win64\OpenLoopControllerSim_1_data.c $(START_DIR)\OpenLoopControllerSim_1_quarc_win64\OpenLoopControllerSim_1_main.c $(START_DIR)\OpenLoopControllerSim_1_quarc_win64\rtGetInf.c $(START_DIR)\OpenLoopControllerSim_1_quarc_win64\rtGetNaN.c $(START_DIR)\OpenLoopControllerSim_1_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = OpenLoopControllerSim_1.obj OpenLoopControllerSim_1_data.obj OpenLoopControllerSim_1_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\OpenLoopControllerSim_1_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\OpenLoopControllerSim_1_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
OpenLoopControllerSim_1.obj : "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\OpenLoopControllerSim_1.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\OpenLoopControllerSim_1.c"


OpenLoopControllerSim_1_data.obj : "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\OpenLoopControllerSim_1_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\OpenLoopControllerSim_1_data.c"


OpenLoopControllerSim_1_main.obj : "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\OpenLoopControllerSim_1_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\OpenLoopControllerSim_1_main.c"


rtGetInf.obj : "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\OpenLoopControllerSim_1_quarc_win64\rt_nonfinite.c"
