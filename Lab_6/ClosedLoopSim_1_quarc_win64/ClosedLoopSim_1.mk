###########################################################################
## Makefile generated for component 'ClosedLoopSim_1'. 
## 
## Makefile     : ClosedLoopSim_1.mk
## Generated on : Tue Oct 18 12:29:41 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\ClosedLoopSim_1.rt-win64
...
COMPILER_COMMAND_FILE     = ClosedLoopSim_1_comp.rsp
CMD_FILE                  = ClosedLoopSim_1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ClosedLoopSim_1.rt-win64
...
DEFINES_STANDARD = -DMODEL=ClosedLoopSim_1 -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\ClosedLoopSim_1_quarc_win64\ClosedLoopSim_1.c $(START_DIR)\ClosedLoopSim_1_quarc_win64\ClosedLoopSim_1_data.c $(START_DIR)\ClosedLoopSim_1_quarc_win64\ClosedLoopSim_1_main.c $(START_DIR)\ClosedLoopSim_1_quarc_win64\rtGetInf.c $(START_DIR)\ClosedLoopSim_1_quarc_win64\rtGetNaN.c $(START_DIR)\ClosedLoopSim_1_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = ClosedLoopSim_1.obj ClosedLoopSim_1_data.obj ClosedLoopSim_1_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\ClosedLoopSim_1_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ClosedLoopSim_1_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ClosedLoopSim_1.obj : "$(START_DIR)\ClosedLoopSim_1_quarc_win64\ClosedLoopSim_1.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopSim_1_quarc_win64\ClosedLoopSim_1.c"


ClosedLoopSim_1_data.obj : "$(START_DIR)\ClosedLoopSim_1_quarc_win64\ClosedLoopSim_1_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopSim_1_quarc_win64\ClosedLoopSim_1_data.c"


ClosedLoopSim_1_main.obj : "$(START_DIR)\ClosedLoopSim_1_quarc_win64\ClosedLoopSim_1_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopSim_1_quarc_win64\ClosedLoopSim_1_main.c"


rtGetInf.obj : "$(START_DIR)\ClosedLoopSim_1_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopSim_1_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\ClosedLoopSim_1_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopSim_1_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\ClosedLoopSim_1_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopSim_1_quarc_win64\rt_nonfinite.c"
