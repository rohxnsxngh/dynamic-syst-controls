...
typedef RT_MODEL_ClosedLoopSim_1_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * ClosedLoopSim_1(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(ClosedLoopSim_1_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: ClosedLoopSim_1 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
