...
#ifndef RTW_HEADER_ClosedLoopImplementation_h_
#define RTW_HEADER_ClosedLoopImplementation_h_
#ifndef ClosedLoopImplementation_COMMON_INCLUDES_
#define ClosedLoopImplementation_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                           /* ClosedLoopImplementation_COMMON_INCLUDES_ */

#include "ClosedLoopImplementation_types.h"
...
#define ClosedLoopImplementation_rtModel RT_MODEL_ClosedLoopImplementa_T

/* Block signals (default storage) */
typedef struct {
  real_T Gain;                         /* '<Root>/Gain' */
} B_ClosedLoopImplementation_T;
...
typedef struct {
  ...
  real_T HILReadOther_Buffer;          /* '<Root>/HIL Read Other' */
  t_card HILInitialize_Card;           /* '<Root>/HIL Initialize' */
  void *HILReadOther_PWORK;            /* '<Root>/HIL Read Other' */
...
} DW_ClosedLoopImplementation_T;

/* Backward compatible GRT Identifiers */
#define rtB                            ClosedLoopImplementation_B
#define BlockIO                        B_ClosedLoopImplementation_T
#define rtP                            ClosedLoopImplementation_P
#define Parameters                     P_ClosedLoopImplementation_T
#define rtDWork                        ClosedLoopImplementation_DW
#define D_Work                         DW_ClosedLoopImplementation_T

/* Parameters (default storage) */
struct P_ClosedLoopImplementation_T_ {
  uint32_T HILReadOther_channels;      /* Mask Parameter: HILReadOther_channels
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T Constant_Value;               /* Expression: 76
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T Gain1_Gain;                   /* Expression: 14.7839^-1
                                        * Referenced by: '<Root>/Gain1'
                                        */
  real_T Gain_Gain;                    /* Expression: -60/4096
  ...
  boolean_T HILInitialize_DOInitial;
                                   ...
                                   * Referenced by: '<Root>/HIL Initialize'
                                   */
  boolean_T HILReadOther_Active;      /* Computed Parameter: HILReadOther_Active
                                       * Referenced by: '<Root>/HIL Read Other'
                                       */
...
struct tag_RTM_ClosedLoopImplementat_T {
  const char_T *path;
...
extern P_ClosedLoopImplementation_T ClosedLoopImplementation_P;

/* Block signals (default storage) */
extern B_ClosedLoopImplementation_T ClosedLoopImplementation_B;

/* Block states (default storage) */
extern DW_ClosedLoopImplementation_T ClosedLoopImplementation_DW;

/* Model entry point functions */
extern void ClosedLoopImplementation_initialize(void);
extern void ClosedLoopImplementation_output(void);
extern void ClosedLoopImplementation_update(void);
extern void ClosedLoopImplementation_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern ClosedLoopImplementation_rtModel *ClosedLoopImplementation(void);
...
extern RT_MODEL_ClosedLoopImplementa_T *const ClosedLoopImplementation_M;
 ...
 *
 * '<Root>' : 'ClosedLoopImplementation'
 */
#endif                              /* RTW_HEADER_ClosedLoopImplementation_h_ */
