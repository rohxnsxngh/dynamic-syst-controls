###########################################################################
## Makefile generated for component 'ClosedLoopImplementation'. 
## 
## Makefile     : ClosedLoopImplementation.mk
## Generated on : Tue Oct 18 11:59:37 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\ClosedLoopImplementation.rt-win64
...
COMPILER_COMMAND_FILE     = ClosedLoopImplementation_comp.rsp
CMD_FILE                  = ClosedLoopImplementation.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ClosedLoopImplementation.rt-win64
...
DEFINES_STANDARD = -DMODEL=ClosedLoopImplementation -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\ClosedLoopImplementation_quarc_win64\ClosedLoopImplementation.c $(START_DIR)\ClosedLoopImplementation_quarc_win64\ClosedLoopImplementation_data.c $(START_DIR)\ClosedLoopImplementation_quarc_win64\ClosedLoopImplementation_main.c $(START_DIR)\ClosedLoopImplementation_quarc_win64\rtGetInf.c $(START_DIR)\ClosedLoopImplementation_quarc_win64\rtGetNaN.c $(START_DIR)\ClosedLoopImplementation_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = ClosedLoopImplementation.obj ClosedLoopImplementation_data.obj ClosedLoopImplementation_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\ClosedLoopImplementation_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ClosedLoopImplementation_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ClosedLoopImplementation.obj : "$(START_DIR)\ClosedLoopImplementation_quarc_win64\ClosedLoopImplementation.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopImplementation_quarc_win64\ClosedLoopImplementation.c"


ClosedLoopImplementation_data.obj : "$(START_DIR)\ClosedLoopImplementation_quarc_win64\ClosedLoopImplementation_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopImplementation_quarc_win64\ClosedLoopImplementation_data.c"


ClosedLoopImplementation_main.obj : "$(START_DIR)\ClosedLoopImplementation_quarc_win64\ClosedLoopImplementation_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopImplementation_quarc_win64\ClosedLoopImplementation_main.c"


rtGetInf.obj : "$(START_DIR)\ClosedLoopImplementation_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopImplementation_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\ClosedLoopImplementation_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopImplementation_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\ClosedLoopImplementation_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\ClosedLoopImplementation_quarc_win64\rt_nonfinite.c"
