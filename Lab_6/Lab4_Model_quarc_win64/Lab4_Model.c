 ...
 * C source code generated on : Tue Oct 18 11:42:38 2022
 *
...
void Lab4_Model_output(void)
{
   ...
   */
  rtb_HILReadOther = Lab4_Model_P.Gain1_Gain * Lab4_Model_P.Constant_Value;

  /* Saturate: '<Root>/Saturation' */
  if (rtb_HILReadOther > Lab4_Model_P.Saturation_UpperSat) {
    rtb_HILReadOther = Lab4_Model_P.Saturation_UpperSat;
  } else if (rtb_HILReadOther < Lab4_Model_P.Saturation_LowerSat) {
...
RT_MODEL_Lab4_Model_T *Lab4_Model(void)
{
  ...
  rtmSetTFinal(Lab4_Model_M, 4.0);
  Lab4_Model_M->Timing.stepSize0 = 0.001;

  /* External mode info */
  Lab4_Model_M->Sizes.checksums[0] = (1982757100U);
  Lab4_Model_M->Sizes.checksums[1] = (2239291776U);
  Lab4_Model_M->Sizes.checksums[2] = (2602241534U);
  Lab4_Model_M->Sizes.checksums[3] = (1604174357U);
  ...
  Lab4_Model_M->Sizes.numBlocks = (9); /* Number of blocks */
  Lab4_Model_M->Sizes.numBlockIO = (1);/* Number of block outputs */
  Lab4_Model_M->Sizes.numBlockPrms = (103);/* Sum of parameter "widths" */
  return Lab4_Model_M;
}
