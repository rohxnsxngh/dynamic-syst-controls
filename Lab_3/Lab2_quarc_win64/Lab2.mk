###########################################################################
## Makefile generated for component 'Lab2'. 
## 
## Makefile     : Lab2.mk
## Generated on : Tue Sep 13 11:58:40 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Lab2.rt-win64
...
COMPILER_COMMAND_FILE     = Lab2_comp.rsp
CMD_FILE                  = Lab2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Lab2.rt-win64
...
DEFINES_STANDARD = -DMODEL=Lab2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Lab2_quarc_win64\Lab2.c $(START_DIR)\Lab2_quarc_win64\Lab2_data.c $(START_DIR)\Lab2_quarc_win64\Lab2_main.c $(START_DIR)\Lab2_quarc_win64\rtGetInf.c $(START_DIR)\Lab2_quarc_win64\rtGetNaN.c $(START_DIR)\Lab2_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Lab2.obj Lab2_data.obj Lab2_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Lab2_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Lab2_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Lab2.obj : "$(START_DIR)\Lab2_quarc_win64\Lab2.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab2_quarc_win64\Lab2.c"


Lab2_data.obj : "$(START_DIR)\Lab2_quarc_win64\Lab2_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab2_quarc_win64\Lab2_data.c"


Lab2_main.obj : "$(START_DIR)\Lab2_quarc_win64\Lab2_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab2_quarc_win64\Lab2_main.c"


rtGetInf.obj : "$(START_DIR)\Lab2_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab2_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Lab2_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab2_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Lab2_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab2_quarc_win64\rt_nonfinite.c"
