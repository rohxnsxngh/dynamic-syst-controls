###########################################################################
## Makefile generated for component 'Lab5_Model'. 
## 
## Makefile     : Lab5_Model.mk
## Generated on : Tue Sep 27 11:26:09 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Lab5_Model.rt-win64
...
COMPILER_COMMAND_FILE     = Lab5_Model_comp.rsp
CMD_FILE                  = Lab5_Model.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Lab5_Model.rt-win64
...
DEFINES_STANDARD = -DMODEL=Lab5_Model -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Lab5_Model_quarc_win64\Lab5_Model.c $(START_DIR)\Lab5_Model_quarc_win64\Lab5_Model_data.c $(START_DIR)\Lab5_Model_quarc_win64\Lab5_Model_main.c $(START_DIR)\Lab5_Model_quarc_win64\rtGetInf.c $(START_DIR)\Lab5_Model_quarc_win64\rtGetNaN.c $(START_DIR)\Lab5_Model_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Lab5_Model.obj Lab5_Model_data.obj Lab5_Model_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Lab5_Model_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Lab5_Model_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Lab5_Model.obj : "$(START_DIR)\Lab5_Model_quarc_win64\Lab5_Model.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab5_Model_quarc_win64\Lab5_Model.c"


Lab5_Model_data.obj : "$(START_DIR)\Lab5_Model_quarc_win64\Lab5_Model_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab5_Model_quarc_win64\Lab5_Model_data.c"


Lab5_Model_main.obj : "$(START_DIR)\Lab5_Model_quarc_win64\Lab5_Model_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab5_Model_quarc_win64\Lab5_Model_main.c"


rtGetInf.obj : "$(START_DIR)\Lab5_Model_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab5_Model_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Lab5_Model_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab5_Model_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Lab5_Model_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab5_Model_quarc_win64\rt_nonfinite.c"
