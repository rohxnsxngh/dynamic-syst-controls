...
void Lab5_Model_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Lab5_Model_M)) {
     ...
     */
    if (Lab5_Model_P.Constant_Value > Lab5_Model_P.Saturation_UpperSat) {
      rtb_Tank1RawFilter = Lab5_Model_P.Saturation_UpperSat;
    } else if (Lab5_Model_P.Constant_Value < Lab5_Model_P.Saturation_LowerSat) {
      rtb_Tank1RawFilter = Lab5_Model_P.Saturation_LowerSat;
    } else {
      rtb_Tank1RawFilter = Lab5_Model_P.Constant_Value;
    }

    /* End of Saturate: '<Root>/Saturation' */

    /* Gain: '<Root>/Gain' */
    Lab5_Model_B.Gain = Lab5_Model_P.Gain_Gain * rtb_Tank1RawFilter;
  }
  ...
  rtb_Tank1RawFilter = Lab5_Model_P.Tank1RawFilter_C *
    Lab5_Model_X.Tank1RawFilter_CSTATE;

  /* TransferFcn: '<S2>/Tank 2 Raw Filter' */
  rtb_DataTypeConversion = Lab5_Model_P.Tank2RawFilter_C *
   ...
   */
  rtb_AND2 = ((rtb_Tank1RawFilter >= Lab5_Model_P.Tank1RestartLevel_Value) ||
              (rtb_DataTypeConversion >= Lab5_Model_P.Tank2RestartLevel_Value));
   ...
   */
  rtb_NOR = (((rtb_Tank1RawFilter >= Lab5_Model_P.Tank1StopLimit_Value) ||
              (rtb_DataTypeConversion >= Lab5_Model_P.Tank2StopLimit_Value)) &&
             rtb_AND2);
  ...
  if (rtmIsMajorTimeStep(Lab5_Model_M)) {
    ...
    Lab5_Model_B.y = 5.874361 * Lab5_Model_B.HILReadAnalog_o2 + 0.002397;
  ...
  Lab5_Model_B.Multiply = (real_T)(((!Lab5_Model_B.Logic[0]) ||
    (!Lab5_Model_B.Logic_i[0])) && ((!(rtb_Tank1RawFilter +
    rtb_DataTypeConversion >= Lab5_Model_P.CombinedVoltageLimit_Value)) ||
    (!Lab5_Model_B.Logic_i[1]))) * Lab5_Model_B.Gain;
  if (rtmIsMajorTimeStep(Lab5_Model_M)) {
...
RT_MODEL_Lab5_Model_T *Lab5_Model(void)
{
  ...
  rtmSetTFinal(Lab5_Model_M, -1);
  Lab5_Model_M->Timing.stepSize0 = 0.001;
  Lab5_Model_M->Timing.stepSize1 = 0.001;

  /* External mode info */
  Lab5_Model_M->Sizes.checksums[0] = (2574749390U);
  Lab5_Model_M->Sizes.checksums[1] = (1596277745U);
  Lab5_Model_M->Sizes.checksums[2] = (104058118U);
  Lab5_Model_M->Sizes.checksums[3] = (994788480U);
  ...
  /* Initialize Sizes */
  Lab5_Model_M->Sizes.numContStates = (3);/* Number of continuous states */
  ...
  Lab5_Model_M->Sizes.numBlocks = (37);/* Number of blocks */
  Lab5_Model_M->Sizes.numBlockIO = (9);/* Number of block outputs */
  Lab5_Model_M->Sizes.numBlockPrms = (148);/* Sum of parameter "widths" */
  return Lab5_Model_M;
}
