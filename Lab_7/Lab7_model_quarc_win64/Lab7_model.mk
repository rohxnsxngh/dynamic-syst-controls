###########################################################################
## Makefile generated for component 'Lab7_model'. 
## 
## Makefile     : Lab7_model.mk
## Generated on : Tue Oct 25 12:19:56 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Lab7_model.rt-win64
...
COMPILER_COMMAND_FILE     = Lab7_model_comp.rsp
CMD_FILE                  = Lab7_model.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Lab7_model.rt-win64
...
DEFINES_STANDARD = -DMODEL=Lab7_model -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Lab7_model_quarc_win64\Lab7_model.c $(START_DIR)\Lab7_model_quarc_win64\Lab7_model_data.c $(START_DIR)\Lab7_model_quarc_win64\Lab7_model_main.c $(START_DIR)\Lab7_model_quarc_win64\rtGetInf.c $(START_DIR)\Lab7_model_quarc_win64\rtGetNaN.c $(START_DIR)\Lab7_model_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Lab7_model.obj Lab7_model_data.obj Lab7_model_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Lab7_model_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Lab7_model_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Lab7_model.obj : "$(START_DIR)\Lab7_model_quarc_win64\Lab7_model.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab7_model_quarc_win64\Lab7_model.c"


Lab7_model_data.obj : "$(START_DIR)\Lab7_model_quarc_win64\Lab7_model_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab7_model_quarc_win64\Lab7_model_data.c"


Lab7_model_main.obj : "$(START_DIR)\Lab7_model_quarc_win64\Lab7_model_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab7_model_quarc_win64\Lab7_model_main.c"


rtGetInf.obj : "$(START_DIR)\Lab7_model_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab7_model_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Lab7_model_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab7_model_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Lab7_model_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Lab7_model_quarc_win64\rt_nonfinite.c"
